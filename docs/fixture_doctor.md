...
- `ledger.csv` -> `dist/fixture-doctor-work/examples/ledger.csv`
- `ledger.json` -> `dist/fixture-doctor-work/examples/ledger.json`
- `portfolio.csv` -> `dist/fixture-doctor-work/examples/portfolio.csv`
...
| `csv-import` | `csv-import --portfolio-csv dist/fixture-doctor-work/examples/portfolio.csv --ledger-csv dist/fixture-doctor-work/examples/ledger.csv --out dist/fixture-doctor-work/csv-import` |
| `csv-export` | `csv-export --packet dist/fixture-doctor-work/packet/liquidity_packet.json --out dist/fixture-doctor-work/csv-export` |
| `input-lint` | `input-lint --portfolio dist/fixture-doctor-work/examples/portfolio.json --ledger dist/fixture-doctor-work/examples/ledger.json --assumptions dist/fixture-doctor-work/examples/assumptions.json --portfolio-csv dist/fixture-doctor-work/examples/portfolio.csv --ledger-csv dist/fixture-doctor-work/examples/ledger.csv` |
| `bundle-checksums` | `bundle-checksums --root dist/fixture-doctor-work --out dist/fixture-doctor-work/bundle-checksums` |
| `evidence-bundle` | `evidence-bundle --root dist/fixture-doctor-work --out dist/fixture-doctor-work/evidence-bundle` |
| `template-pack` | `template-pack --out dist/fixture-doctor-work/template-pack` |
...
| `artifact-catalog` | `artifact-catalog --root dist/fixture-doctor-work --paths packet,dashboard,scenario-gallery,assumption-audit,batch-compare,casebook,schema-export,csv-import,csv-export,static-docs --out dist/fixture-doctor-work/catalog` |
...
| `csv-import` | `pass` | `dist/fixture-doctor-work/csv-import/portfolio.json`, `dist/fixture-doctor-work/csv-import/ledger.json`, `dist/fixture-doctor-work/csv-import/import_report.json`, `dist/fixture-doctor-work/csv-import/import_report.md` |  |
| `csv-export` | `pass` | `dist/fixture-doctor-work/csv-export/assets.csv`, `dist/fixture-doctor-work/csv-export/runway.csv`, `dist/fixture-doctor-work/csv-export/warnings.csv`, `dist/fixture-doctor-work/csv-export/bucket_summaries.csv`, `dist/fixture-doctor-work/csv-export/export_manifest.json`, `dist/fixture-doctor-work/csv-export/export_manifest.md` |  |
| `input-lint` | `pass` | `stdout JSON` |  |
| `bundle-checksums` | `pass` | `dist/fixture-doctor-work/bundle-checksums/SHA256SUMS.txt`, `dist/fixture-doctor-work/bundle-checksums/bundle_manifest.json`, `dist/fixture-doctor-work/bundle-checksums/bundle_manifest.md` |  |
| `evidence-bundle` | `pass` | `dist/fixture-doctor-work/evidence-bundle/index.md`, `dist/fixture-doctor-work/evidence-bundle/index.html`, `dist/fixture-doctor-work/evidence-bundle/SHA256SUMS.txt`, `dist/fixture-doctor-work/evidence-bundle/evidence_manifest.json` |  |
| `template-pack` | `pass` | `dist/fixture-doctor-work/template-pack/README.md`, `dist/fixture-doctor-work/template-pack/template_manifest.json` |  |
