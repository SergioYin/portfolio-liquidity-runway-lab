...
liquidity-demo/template-pack/portfolio.csv
liquidity-demo/template-pack/ledger.csv
liquidity-demo/template-pack/portfolio.json
liquidity-demo/template-pack/ledger.json
liquidity-demo/template-pack/assumptions.json
...
The packet, gallery, audit, batch compare, casebook, schema guide, checksum bundle, evidence bundle, template pack, fixture diagnosis, static docs, catalog, and visual receipt artifacts should be deterministic for the same inputs. HTML artifacts are static and contain no JavaScript.
